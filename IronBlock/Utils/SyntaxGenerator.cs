...
namespace IronBlock.Utils
{
    ...
    {
        public static MemberAccessExpressionSyntax PropertyAccessExpression(ExpressionSyntax targetExpression,
            string propertyName)
        {
            return
        ...
        public static InvocationExpressionSyntax MethodInvokeExpression(ExpressionSyntax targetExpression,
            string methodName, IEnumerable<ExpressionSyntax> argumentExpressions = null)
        {
